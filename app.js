...
book1.addRating(5);
book1.addRating(4);
console.log(book1.getAverageRating());  // Output: 4.5
book1.toggleCheckOutStatus();
console.log(book1.isCheckedOut);  // Output: true

const movie1 = new Movie("Steven Spielberg", "Jurassic Park", 127);
movie1.addRating(5);
console.log(movie1.getAverageRating());  // Output: 5

const cd1 = new CD("The Beatles", "Abbey Road", ["Come Together", "Something"]);
cd1.toggleCheckOutStatus();
console.log(cd1.isCheckedOut);  // Output: true
